...
function App() {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'dark' : ''} p-4 md:p-8 text-sm font-bold print:bg-white print:p-0 antialiased print-container transition-colors duration-500`}>
